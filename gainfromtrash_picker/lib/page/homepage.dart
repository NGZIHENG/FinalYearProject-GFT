...
class HomePage extends StatefulWidget {
  final Picker picker;
  const HomePage({super.key, required this.picker});
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {Navigator.push(context,MaterialPageRoute(builder: (content) => ProfileScreen(picker: widget.picker)));},
                      )
                    ),
                  ),
                    ...
                    child: GridView.count(
                      ...
                      children: <Widget>[
                        CategoryCard(
                          ...
                          press: (){Navigator.push(context,MaterialPageRoute(builder: (content) => AppointmentStatusScreen(picker: widget.picker)));},
                        ),
                        CategoryCard(
                          title: "Withdrawal History",
                          image: "assets/atm.png",
                          press: (){Navigator.push(context,MaterialPageRoute(builder: (content) => WithdrawalStatusScreen(picker: widget.picker)));},
                        ),
                        CategoryCard(
                          title: "Price List",
