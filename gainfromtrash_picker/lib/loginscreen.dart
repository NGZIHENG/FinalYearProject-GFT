...
import 'package:gainfromtrash_picker/registrationscreen.dart';
...
class _LogInScreenState extends State<LogInScreen> {
      ...
      body: Container(
        ...
        child:Column(
          ...
          children: [
            Flexible(
            flex: 1,
            child: Image.asset('assets/gftonlypicker.png',scale:1) 
            ),
            Center(
  ...
  void loginUser() {
    ...
    http.post(Uri.parse("${Config.server}/gainfromtrash/php/login_picker.php"),
      ...
      if (response.statusCode == 200 && jsonResponse['status'] == "success") {
        ...
        Navigator.push(context,
            MaterialPageRoute(builder: (content) => MainScreen(picker: picker)));
      } else {
        Fluttertoast.showToast(
            msg: "Login Failed",
            toastLength: Toast.LENGTH_SHORT,
