...
class _ProfileScreenState extends State<ProfileScreen> {
                        ...
                        child: ListView(
                            ...
                            children: [
                              ElevatedButton.icon(
                                ...
                                style: ButtonStyle(
                                  backgroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(255, 73, 91, 73)),
                                ),
                              ),
                              const Divider(
                                height: 8,
                              ...
                              ElevatedButton.icon(
                                ...
                                style: ButtonStyle(
                                  backgroundColor: MaterialStateProperty.all<Color>(Color.fromARGB(255, 243, 93, 83)),
                                ),
                              ),
                            ]
                        )
  ...
  void updateName(String newname) {
    http.post(Uri.parse("${Config.server}/gainfromtrash/php/update_profile.php"),
        body: {
